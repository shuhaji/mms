        ...
        renderElement: function () {
            ...
            this.$(".coupons").click(function () {
                self.gui.show_popup('coupon',{
                    'title': _t('Enter your MyValue ID'),
                });
            });
        },
    });
                    ...
                    if(self.pos.get_client()){
                        ...
                        if(coupon_res && coupon_res[0]['total_avail'] > 0){
                            ...
                            // this customer has not used this coupon yet
                                ...
                                flag = false;
                                $(".coupon_status_p").text("Unable to apply MyValue. Check MyValue validity.!");
                            }
                        }
                        else{
                            flag = false;
                            $(".coupon_status_p").text("MyValue ID not found. \nPlease check your MyValue ID validity.");
                        }
                        if(flag){
                            ...
                            var val = coupon_res[0]['type'] == 'fixed' ?
                                coupon_res[0]['voucher_val'] : coupon_res[0]['voucher_val'] + "%";
                            var obj = $(".coupon_status_p").text("Total points is : "+val+" \n" +
                                " Do you want to proceed ? \n This operation cannot be reversed.");
                        ...
                        if(flag){
                           $(".confirm-coupon").css("display", "block");
                            ...
                            var ob = $(".coupon_status_p").text("MyValue ID not found. \nPlease check your MyValue ID validity.");
            ...
            this.$(".confirm-coupon").click(function () {
                ...
                if(self.flag){
                    ...
                    if(order.coupon){
                        ...
                        self.gui.show_popup('error',{
                            'title': _t('Unable to apply MyValue !'),
                            'body': _t('Either MyValue is already applied or you have not selected any products.'),
                        });
                    }
                    else{
                        if(lines.models.length > 0 && order.check_voucher_validy()) {
                            ...
                            if ((order.get_total_with_tax - price) <= 0) {
                                ...
                                self.gui.show_popup('error', {
                                    'title': _t('Unable to apply MyValue !'),
                                    'body': _t('Aamount is too large to apply MyValue. The total amount cannot be negative'),
                                });
                            }
                            else{
                            ...
                            self.gui.show_popup('error',{
                                'title': _t('Unable to apply MyValue !'),
                                'body': _t('This MyValue is not applicable on the products or category you have selected !'),
                            });
                        }
                    }
                }
