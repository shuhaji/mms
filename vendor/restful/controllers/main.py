...
from odoo.addons.restful.common import valid_response, invalid_response, extract_arguments, HTTP_METHOD_OPTION
...
class APIController(http.Controller):
    ...
    @http.route(_routes, type='http', auth="none", methods=['OPTIONS'],
                csrf=False)
    def options(self, model=None, id=None, **payload):
        return valid_response({}, http_method=HTTP_METHOD_OPTION)

    @http.route(_routes, type='http', auth="none", methods=['GET'],
                cors="*", csrf=False)
    @validate_token
    ...
    @http.route(_routes, type='http', auth="none", methods=['POST'],
                cors="*", csrf=False)
    @validate_token
    ...
    @http.route(_routes, type='http', auth="none", methods=['PUT'],
                cors="*", csrf=False)
    @validate_token
    ...
    @http.route(_routes, type='http', auth="none", methods=['DELETE'],
                cors="*", csrf=False)
    @validate_token
    ...
    @http.route(_routes, type='http', auth="none", methods=['PATCH'],
                cors="*", csrf=False)
    @validate_token
