...
class WizardJournalAudit(models.TransientModel):
    _inherit = ['wizard.kg.report.base', 'account.print.journal']
    _name = 'wizard.kg.report.journal'
    _title = "KG Report - Journal Audit"
    ...
    def get_report_values(self, data=None):
        ...
        current_company, end_date, sql_sort, start_date, where_journal_id, where_state, where_journal_id_sum = self.query_get_clause(data)
    ...
    def query_get_clause(self, data):
        ...
        return current_company, end_date, sql_sort, start_date, where_journal_id, where_state, where_journal_id_sum
    ...
    def _define_report_name():
        ...
        :return: str
        """
        return "/kg_account/static/rpt/JournalAudit.mrt"
