...
models.load_models({
    ...
    fields: ['name','width','height','position_h','position_v','shape','floor_id','color','seats','current_booking'],
...
var TableWidget = PosBaseWidget.extend({
    ...
    // Custom: bug fix odoo error if pricelist is undefined
    calculate_cache_key: function(product, pricelist){
        return product.id + ',' + (pricelist ? pricelist.id : '0');
    },
    ...
    renderElement: function(){
        ...
        this.current_booking = this.table.current_booking;
...
models.PosModel = models.PosModel.extend({
    ...
    set_table: function(table) {
        // show reservation button when table is load again by mario ardi;
        document.getElementById('pos_order_list_button').style.display = "block";
